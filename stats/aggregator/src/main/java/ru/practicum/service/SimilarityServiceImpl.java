...
import ru.practicum.kafka.UserActionWeightConfig;
...
public class SimilarityServiceImpl implements SimilarityService {
    ...
    public List<EventSimilarityAvro> updateSimilarity(UserActionAvro userAction) {
        ...
        double oldWeight = eventWeights.computeIfAbsent(eventId, e -> new HashMap<>()).getOrDefault(userId, 0.0);
        ...
        eventWeights.computeIfAbsent(eventId, e -> new HashMap<>()).merge(userId, newWeight, Math::max);
